...
class PushupCounterApp:
    def __init__(self, root):
        ...
        # Threshold variables with default values from the prompt
    ...
    def load_video(self):
        ...
        if self.video_path:
            ...
            pc.counter = 0 # Reset counter in the module
            pc.status = "up"
            self.counter_label.config(text="Push-ups: 0")
    ...
    def update_frame(self):
        ...
        if self.cap and self.cap.isOpened():
            ...
            if ret:
                ...
                processed_frame, count, status = pc.process_frame(
                    frame,
                ...
                self.stop_processing()
                self.show_first_frame() # Show the first frame again to indicate video ended
